...
def draw_boxes(image_path, label_path):
    ...
    for ln in lines:
        ...
        # convert normalized center format to pixel box
        cx, cy = x * w, y * h
        bw, bh = bw * w, bh * h
        ...
        color = (0, 0, 255) if cls == 0 else (0, 255, 0)  # fire=red, smoke=green
...
def main():
    images = list(IMG_DIR.glob("*.jpg"))[16192:17000]  # show first 100 images
